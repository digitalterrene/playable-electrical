        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 space-x-1">
          <div className="col-span-6 flex flex-col justify-evenly">
            <div className="flex gap-2 mx-auto lg:mx-0">
              ...
              <h3 className="text-kellygreen text-sm font-semibold text-center lg:text-start">
                Why Choose Playable Electrical
              </h3>
            </div>
            ...
            <h3 className="text-charcoal text-lg font-normal text-center lg:text-start opacity-75 pt-5 lg:pt-0">
              In all or projects, big or small, we care about the safety of our
              clients.
            </h3>
          ...
          <div className="col-span-6 p-4 flex justify-center">
            <img
              ...
              src="https://img.freepik.com/free-vector/hand-drawn-electrician-cartoon-illustration_23-2151046712.jpg?t=st=1715338328~exp=1715341928~hmac=d58403dc0aa96635851535eb707e6ed380f25837ba60ba0de30e807e9d42acd8&w=826"
              alt="nothing"
              width={1000}
              height={805}
            />
