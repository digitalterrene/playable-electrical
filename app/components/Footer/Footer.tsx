...
const products: ProductType[] = [
    {
        id: 1,
        section: "Company",
        link: ['About Us',  'Why Choose Us', 'FAQs', 'How we work?'],
    },
    {
        id: 2,
        section: "Contact",
        link: ['Help/FAQ', 'Socials', 'Affiliates',  'Partners']
    }
    ,
    {
        id: 3,
        section: "More",
        link: ['Cookie Policy', 'Terms & Conditions', 'Privacy Policy', 'Disclaimer' ]
    }
]
        ...
        <div className="mx-auto max-w-2xl sm:pt-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="my-12 grid grid-cols-1 gap-y-10 sm:grid-cols-6 lg:grid-cols-12">
                ...
                <div className='sm:col-span-6 lg:col-span-5'>
                    ...
                    <h1 className='font-bold text-[#6556FF] text-xl'>Playable Electrical</h1>
                    </div>
                    <h3 className='text-xs font-medium text-gunmetalgray lh-160 mt-5 mb-4 lg:mb-16'> Doing electrical the right way <br /> with qualityt and safety in mind.</h3>
            ...
            <div className='py-10 md:flex items-center justify-between border-t border-t-gray-blue'>
                <h4 className='text-dark-red opacity-75 text-sm text-center md:text-start font-normal'>@2024 Playable Electrical All rights reserved</h4>
